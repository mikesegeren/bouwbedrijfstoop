<template>
  <div class="container">
    <div v-if="projects.length">
      <h1 class="text-primary mb-3 font-weight-bold">Projecten</h1>
      <p class="my-4">
        Hieronder ziet u een selectie uit de projecten die wij door de jaren heen gedaan hebben.
      </p>

      <div class="row">
        <div v-for="project in projects" class="col-md-4 col-sm-6 col-lg-3 mb-3">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <nuxt-link :to="'/projecten/' + project.slug" class="btn btn-primary font-weight-bold w-100">Meer
                informatie
              </nuxt-link>
            </div>
          </div>
  ...
  export default {
    ...
    async fetch() {
      this.projects = await fetch(`${config.api}/projects`)
        ...
        .then(res => res.filter(project => project.type === 'pstoop'))
    },
    methods: {
